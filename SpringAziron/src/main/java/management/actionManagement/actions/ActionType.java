...
public enum ActionType {
    ...
    , PLAYER_OUT, END_GAME, BEFORE_USED_POSSIBILITY, AFTER_USED_POSSIBILITY, BEFORE_USED_SWAP_SKILL, AFTER_USED_SWAP_SKILL, BEFORE_GETTING_EXPERIENCE, AFTER_GETTING_EXPERIENCE, GET_FRAME
}
