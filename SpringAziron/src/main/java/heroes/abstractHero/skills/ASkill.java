...
public abstract class ASkill extends APossibility {

    protected ASkill(final String name, final int reload, final int requiredLevel, final List<Double> coefficients
